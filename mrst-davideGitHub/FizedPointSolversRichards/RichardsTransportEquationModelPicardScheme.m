classdef RichardsTransportEquationModelPicardScheme < TwoPhaseOilWaterModel
    properties
        % Polymer present
        polymer
        Picard
    ...
    methods
        function model = RichardsTransportEquationModelPicardScheme(G, rock, fluid, varargin) % no varagin
          ...
          % This is the model parameters for oil/water/polymer
            model.polymer = true;
            model = merge_options(model,varargin{:}); % no varagin
        end
