        ...
        function [state, report] = stepFunction(model, state, state0, dt,...
            ...
            if converged %&& ~model.stepFunctionIsLinear   %we want always the outer loop
               ...
               % end
                ...
                %{
                     [~, values] = model.RichardsEquationModel.checkConvergence(problem);  
                    alues = pressureReport.StepReports{end}.NonlinearReport{end}.Residuals(1);
                    values_p = pressureReport.StepReports{end}.NonlinearReport{end}.NormPressure   
                    values_c = transportReport.StepReports{end}.NonlinearReport{end}.NormConcentration
               ...
               converged = converged_p && converged_c && converged_c1 && converged_p1;
                %}
               ...
               converged = all(values_p < model.outerTolerance) && all(values_c < model.outerTolerance);  
