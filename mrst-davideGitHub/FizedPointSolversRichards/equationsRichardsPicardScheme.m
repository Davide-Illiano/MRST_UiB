function [problem, state] = equationsRichardsPicardScheme(state0, state, model, dt, drivingForces, varargin)
...
water = (V./dt).*( bW.*sW - bW0.*sW0 + theta_first.*(p - p_prev)) + s.Div(bWvW);
