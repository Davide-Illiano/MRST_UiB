...
%}
    ...
    for i = 1:nSteps
        ...
        %Introduce analytical forces
        
        schedule.control(i).analyticalForce1 = model.forces(i).analyticalForce1;
        schedule.control(i).analyticalForce2 = model.forces(i).analyticalForce2;
        
        
        forces{8} = model.forces(i).analyticalForce1;
        forces{10} = model.forces(i).analyticalForce2;
        %}
        step_header(i);
        state0 = state;
